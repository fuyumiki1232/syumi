...
:fupcheck
for /f "usebackq" %%t in (`"powershell (invoke-webrequest -uri https://nonbiri0220.github.io/syumi/kiosuu/version.txt).content"`) do set checkversion=%%t
goto fupselect
...
:release
cls
powershell (invoke-webrequest -uri https://nonbiri0220.github.io/syumi/kiosuu/release.txt).content
...
:update
powershell invoke-webrequest -uri https://nonbiri0220.github.io/syumi/share/記憶数字タイピング.bat -outfile %folderpath%記憶数字タイピング%checkversion%.bat
echo アップデートが完了しました。
